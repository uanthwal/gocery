...
import com.mobilecomputing.one_sec.receiver.LockRestarterBroadcastReceiver;
...
public class LockService extends IntentService {
    ...
    public void onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationUtil.createNotification(this, "One-Sec", "One-Sec running in background");
        }
