...
import com.mobilecomputing.one_sec.utils.StatusBarUtil;
...
import com.mobilecomputing.one_sec.widget.UnLockMenuPopWindow;
            ...
            public void onPatternDetected(@NonNull List<LockPatternView.Cell> pattern) {
                if (mLockPatternUtils.checkPattern(pattern)) { //
                    ...
                    if (actionFrom.equals(AppConstants.LOCK_FROM_LOCK_MAIN_ACITVITY)) {
                        startActivity(new Intent(GestureUnlockActivity.this, MainActivity_AppLock.class));
                        finish();
                    } else {
