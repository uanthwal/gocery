...
public class AppListAdapter extends RecyclerView.Adapter<AppListAdapter.MainViewHolder> {
    ...
    @NonNull
    @Override
    public AppListAdapter.MainViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_main_list, parent, false);
        return new AppListAdapter.MainViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final AppListAdapter.MainViewHolder holder, final int position) {
